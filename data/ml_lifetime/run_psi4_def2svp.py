"""
Run HF/def2-SVP on all 37 key intermediates. Supports all elements including I/Br.
  conda run -n base python data/ml_lifetime/run_psi4_def2svp.py
"""
...
CACHE_PATH = DATA_DIR / "hf_def2svp_cache.json"
...
def run_one(xyz_path, li_idx, c_idx):
    ...
    try:
        ...
        e, wfn = psi4.energy("hf/def2-svp", molecule=mol, return_wfn=True)
